 ...
 */
"use strict";var r=e(129),o=r;o=function(e,t){for(var n=[],r=2,o=arguments.length;o>r;r++)n.push(arguments[r]);if(void 0===t)throw new Error("`warning(condition, format, ...args)` requires a warning message argument");if(t.length<10||/^[s\W]*$/.test(t))throw new Error("The warning format should be able to uniquely identify this warning. Please, use a more descriptive format than: "+t);if(0!==t.indexOf("Failed Composite propType: ")&&!e){var a=0,i="Warning: "+t.replace(/%s/g,function(){return n[a++]});console.warn(i);try{throw new Error(i)}catch(s){}}},t.exports=o},{129:129}]},{},[1])(1)});var NavBar=React.createClass({displayName:"NavBar",propTypes:{klass:React.PropTypes.string},render:function(){return React.createElement("div",{className:this.props.klass},React.createElement("div",{className:"pure-menu pure-menu-horizontal"},React.createElement("a",{href:"/",className:"pure-menu-heading pure-menu-link"},"D.YU"),React.createElement("div",{className:"nav-right"},React.createElement("ul",{className:"pure-menu-list"},React.createElement("li",{className:"pure-menu-item"},React.createElement("a",{href:"#",id:"link_one",className:"pure-menu-link"},"Projects")),React.createElement("li",{className:"pure-menu-item"},React.createElement("a",{href:"#",id:"link_two",className:"pure-menu-link"},"About")),React.createElement("li",{className:"pure-menu-item"},React.createElement("a",{href:"#",id:"link_three",className:"pure-menu-link"},"Contact"))))))}});window.onload=function(){React.render(React.createElement(NavBar,{klass:"navbar-container"}),document.getElementById("navbar"))};